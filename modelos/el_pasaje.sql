...
CREATE TABLE IF NOT EXISTS `Eventos` (
  ...
  `imagenEve` LONGBLOB NULL,
  `idLug` INT NULL,
  `dProv` INT NULL,
  PRIMARY KEY (`idEve`),
  INDEX `fk_Eventos_Lugares1_idx` (`idLug` ASC),
  INDEX `fk_Eventos_Proveedores1_idx` (`dProv` ASC),
  CONSTRAINT `fk_Eventos_Lugares1`
    FOREIGN KEY (`idLug`)
    REFERENCES `Lugares` (`idLug`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_Eventos_Proveedores1`
    FOREIGN KEY (`dProv`)
...
CREATE TABLE IF NOT EXISTS `CarritoCompra` (
  ...
  `idEve` INT NULL,
  PRIMARY KEY (`idCC`),
  INDEX `fk_CarritoCompra_Clientes1_idx` (`idCli` ASC),
  INDEX `fk_CarritoCompra_TipoBoleta1_idx` (`idTB` ASC),
